...
Using the minimum specification in Section 2 of the lesson, complete the due-diligence record that should have existed before the benefits-eligibility vendor was onboarded. For each field, state whether it was actually addressed at signing (per the case facts), and if not, what specific finding that gap represents.

## Part 2 — AI bill of materials request

Draft a request to this vendor for an AI bill of materials, per Section 3. Name at least four specific elements you would require, and state what you would do if the vendor could not produce them.
...
Design an ongoing vendor-governance plan per Section 6: a reattestation cadence, at least one planned exercise of the audit/inspection right, and a sub-processor-tracking approach. Justify the cadence by the use case's tier, not by a default calendar choice.
...
In no more than 200 words, summarize to an executive audience the vendor-governance gaps this retroactive review found, what contract and due-diligence changes are now needed, and what remains an open risk. Do not claim the vendor relationship is now fully governed if your own Part 3 checklist shows a control still absent or unverified.
