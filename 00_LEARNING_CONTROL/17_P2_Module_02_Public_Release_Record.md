...
**Module:** Use-Case Classification and Risk Tiers
...
The package includes the lesson, participant workbook, model answer/review guide, source-register update, and navigation/content-register changes. It develops executive and program-lead judgment about assigning a risk tier to an inventoried AI use case, tying each tier to a specific and checkable governance obligation, designing an intake process that classifies before deployment, resisting tier creep in self-classified submissions, and defining reclassification triggers.

Publication does not establish learner completion, production readiness, independent peer review, or professional authority. The tier model, intake design, and fictional case are original educational synthesis, not a NIST-, ISO-, or OMB-prescribed scheme or a legal risk classification.
